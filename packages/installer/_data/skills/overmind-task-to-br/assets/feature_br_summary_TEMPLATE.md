...
- source_refs: [UNFILLED]
- last_updated: [UNFILLED]
- ready_to_ears: [UNFILLED]
...
- jira_link: [UNFILLED]
- related_docs: [UNFILLED]

### 2.3 Explicitly stated in source
- stated_goals: [UNFILLED]
- stated_scope: [UNFILLED]
- stated_acceptance_criteria: [UNFILLED]
- stated_constraints: [UNFILLED]
- stated_non_goals: [UNFILLED]

## 3. Feature Intent
### 3.1 Business goal
- primary_business_goal: [UNFILLED]
- expected_business_value: [UNFILLED]
- problem_being_solved: [UNFILLED]

### 3.2 Success outcome
- desired_outcome: [UNFILLED]
- success_signals: [UNFILLED]

### 3.3 Why now
- business_priority_reason: [UNFILLED]
- milestone_or_deadline: [UNFILLED]
...
- secondary_actors: [UNFILLED]

### 4.3 Affected downstream and upstream consumers
- dependent_systems: [UNFILLED]
- impacted_consumers: [UNFILLED]

## 5. Scope Definition
### 5.1 In scope
- in_scope_items: [UNFILLED]

### 5.2 Out of scope
- out_of_scope_items: [UNFILLED]
...
- who_can_do_what: [UNFILLED]
- ownership_rules: [UNFILLED]
- role_constraints: [UNFILLED]
- auth_related_constraints: [UNFILLED]
- tenant_or_visibility_constraints: [UNFILLED]

## 9. State and Data Expectations
- entities_involved: [UNFILLED]
- data_inputs_required: [UNFILLED]
- data_outputs_required: [UNFILLED]
- state_changes_expected: [UNFILLED]
- persistence_expectations: [UNFILLED]
- audit_or_history_expectations: [UNFILLED]
- idempotency_or_uniqueness_expectations: [UNFILLED]

## 10. Failure Cases and Edge Cases
### Negative and rejection cases
- rejection_cases: [UNFILLED]
...
- upstream_dependencies: [UNFILLED]
- downstream_dependencies: [UNFILLED]
- external_systems_involved: [UNFILLED]
- contract_or_api_expectations: [UNFILLED]
- event_or_async_expectations: [UNFILLED]
- prerequisite_capabilities: [UNFILLED]

## 12. Non-Functional Requirements
### 12.1 Security and privacy
- security_requirements: [UNFILLED]
...
- reliability_expectations: [UNFILLED]
...
- required_test_levels: [UNFILLED]
- special_quality_constraints: [UNFILLED]
...
- confirmed_assumptions: [UNFILLED]
