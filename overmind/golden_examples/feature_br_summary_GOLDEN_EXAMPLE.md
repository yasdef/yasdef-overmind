...
- unclear_scope_points: Whether SMS fallback is required for pilot cohort.
...
### Needs validation
- assumptions_needing_validation: Whether SMS fallback is required by compliance.

## 15. Open Questions
### Critical questions
- critical_questions: Is forced MFA re-verification required after reset?
