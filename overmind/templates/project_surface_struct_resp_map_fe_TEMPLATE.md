...
- in_scope_feature_delta: [UNFILLED]
- out_of_scope_notes: [UNFILLED]
...
> only for mobile repositories
- surface_summary: Native bridges, device permissions, push notifications, deep links, camera or biometric hooks.
- applicability: [UNFILLED]
- repo_paths: [UNFILLED]
- why_feature_touches_it: [UNFILLED]
- expected_changes: [UNFILLED]
...
> only for mobile repositories
- surface_summary: Local persistence, offline cache, background sync, queue replay, app lifecycle recovery.
- applicability: [UNFILLED]
- repo_paths: [UNFILLED]
- why_feature_touches_it: [UNFILLED]
- expected_changes: [UNFILLED]
